...
const CATALOG: &[ShaderMeta] = &[
    ...
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× CNN апскейл — очень быстрый (VL)",
        speed_factor: 0.82,
        is_default: false,
    ...
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× CNN апскейл — ультра-быстрый (UL)",
        speed_factor: 0.70,
        is_default: true,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× CNN апскейл — лёгкий (L)",
        speed_factor: 0.55,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× CNN апскейл — средний (M)",
        speed_factor: 0.40,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× CNN апскейл — стандартный, качество (S)",
        speed_factor: 0.25,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл + шумодав — очень быстрый (VL)",
        speed_factor: 0.78,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл + шумодав — ультра-быстрый (UL)",
        speed_factor: 0.65,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл + шумодав — лёгкий (L)",
        speed_factor: 0.50,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл + шумодав — средний (M)",
        speed_factor: 0.35,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл + шумодав — стандартный (S)",
        speed_factor: 0.20,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл + деblur (оригинал)",
        speed_factor: 0.60,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл + деblur (DoG)",
        speed_factor: 0.62,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл — оригинальный алгоритм (быстрый)",
        speed_factor: 0.75,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл — DTD алгоритм",
        speed_factor: 0.68,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ShaderMeta {
        ...
        category: "upscale",
        description_ru: "2× апскейл — DoG алгоритм",
        speed_factor: 0.70,
        is_default: false,
        exclusive_group: Some("upscale"),
    },
    ...
    ShaderMeta {
        ...
        category: "postprocess",
        description_ru: "Предобработка даунскейла 2× (если цель меньше 2×)",
        speed_factor: 0.95,
        is_default: false,
    ...
    ShaderMeta {
        ...
        category: "postprocess",
        description_ru: "Предобработка даунскейла 4× (если цель меньше 4×)",
        speed_factor: 0.92,
        is_default: false,
        exclusive_group: Some("auto_downscale"),
    },
