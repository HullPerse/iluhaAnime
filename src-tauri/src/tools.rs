...
const TOOLS: &[Tool] = &[
    Tool {
        ...
        download_url: "https://github.com/xinntao/Real-ESRGAN/releases/download/v0.3.0/realesrgan-ncnn-vulkan-v0.3.0-windows.zip",
    ...
    Tool {
        ...
        download_url: "https://github.com/nihui/rife-ncnn-vulkan/releases/download/20230816/rife-ncnn-vulkan-20230816-windows.zip",
    ...
    Tool {
        ...
        download_url: "https://github.com/ggerganov/whisper.cpp/releases/download/v1.7.4/whisper-cli-v1.7.4-win-x64.zip",
    ...
    Tool {
        ...
        download_url: "https://github.com/mpv-player/mpv/releases/download/v0.41.0/mpv-v0.41.0-x86_64-w64-mingw32.zip",
...
pub async fn download_tool(
    ...
    let ext = match tool.archive_format {
