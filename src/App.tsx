...
function App() {
  ...
  return (
    <main className="relative h-screen w-screen text-text overflow-hidden gap-2 p-2 items-center bg-[#018281]">
      {/* WALLPAPER */}
      {/*<div
      ...
      <div className="relative z-10 h-full flex flex-col w-full">
        <section className=" flex flex-row gap-2 w-full mb-1">
          <Input
              ...
              >
                ...
                <div className="mt-1 flex gap-1">
                  ...
                  {item.torrent && (
                    <a
                      href={
                        item.torrent.startsWith("http")
                          ? item.torrent
                          : `https://animetosho.org${item.torrent}`
                      }
                      className="border-2 border-solid border-t-white border-l-white border-b-muted border-r-muted bg-[#c0c0c0] px-2 py-0.5 text-[11px] font-['MS_Sans_Serif','Microsoft_Sans_Serif','Segoe_UI',system-ui] text-text no-underline active:border-t-muted active:border-l-muted active:border-b-white active:border-r-white"
                    >
                      Torrent
