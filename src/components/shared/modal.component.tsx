...
function Modal({ header, onClose, children }: ModalWindow) {
  return (
    <main className="flex flex-col absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 inset-0 z-50 items-center w-150 h-fit min-h-42 max-h-[80vh] windows95-active-border bg-primary shadow-lg">
      ...
      <section className="flex flex-col gap-1 p-2 overflow-hidden flex-1 w-full">
        {children}
      </section>
    </main>
  );
