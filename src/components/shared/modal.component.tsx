  ...
  return (
    ...
    >
      <Dialog.Portal className="z-9999">
        ...
        <Dialog.Popup
          className={cn(
            "bg-primary windows95-active-border fixed top-1/2 left-1/2 z-50 flex h-fit max-h-[calc(90vh-1rem)] min-h-0 w-[min(720px,calc(100vw-1rem))] max-w-[calc(100vw-1rem)] -translate-x-1/2 -translate-y-1/2 flex-col items-center",
