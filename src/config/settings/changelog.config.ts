...
export const CHANGELOG: ChangelogVersion[] = [
  {
    ...
    added: [
      ...
      entry("changelog.4_1_2.added.airing_countdown", "anilist"),
      ...
      entry("changelog.4_1_2.added.random_discovery", "anilist"),
    ],
    changed: [
      ...
      entry("changelog.4_1_2.changed.activity_calendar", "anilist"),
    ],
    fixed: [
