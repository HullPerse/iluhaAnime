const changelog400 = {
  "changelog.4_0_0.added.modern_tab": "Modern search tab with a dithering wallpaper lab",
  ...
  "changelog.4_0_0.added.random_menu": "Random item picker in the collection data menu",
  "changelog.4_0_0.added.random_filters": "Random anime picker from AniList filters",
  "changelog.4_0_0.added.deeplinks": "Shareable iluhaanime:// anime links with a copy button",
  ...
  "changelog.4_0_0.added.franchise": "Franchise list and Similar section in anime details",
  "changelog.4_0_0.added.fav_people":
    "Favourites for titles, staff, and characters from AniList views",
  "changelog.4_0_0.added.bilingual_labels": "Custom status labels in two languages",
  "changelog.4_0_0.added.descriptions": "Collection descriptions from AniList and TMDB",
  "changelog.4_0_0.added.filmstrip": "Stills filmstrip viewer inside the app",
  "changelog.4_0_0.added.fonts": "Global font selector with system fonts and file upload",
  ...
  "changelog.4_0_0.changed.anilist_tags": "Tags are collection-only and merge into genres",
  "changelog.4_0_0.changed.jobcenter":
    "Task center removed; queue and folder scan keep their own panels",
  "changelog.4_0_0.changed.semantic": "Offline semantic search removed",
  "changelog.4_0_0.changed.gif": "Animated GIFs no longer accepted as wallpaper",
  ...
  "changelog.4_0_0.changed.squares": "AniList list tabs show collection-style status squares",
  "changelog.4_0_0.changed.tmdb_key": "TMDB key moved to the OS keyring with v4 token support",
  "changelog.4_0_0.changed.list_rows":
    "Collection list rows open details and show a studio/year/genres line",
  "changelog.4_0_0.changed.autopause": "Auto-pause fires once when a download finishes",
  "changelog.4_0_0.changed.hints": "Shorter UI hints across settings and modals",
  "changelog.4_0_0.changed.plurals_time": "Correct Russian plurals and one shared time formatter",
  "changelog.4_0_0.fixed.crash": "Player no longer crashes while torrent file states load",
  ...
  "changelog.4_0_0.fixed.refresh_touch": "Metadata refresh no longer moves items in date sorting",
  "changelog.4_0_0.fixed.tmdb_covers": "TMDB covers load through the backend cache",
} as const;
