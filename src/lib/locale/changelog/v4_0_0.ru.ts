const changelog400 = {
  "changelog.4_0_0.added.modern_tab": "Современная вкладка поиска с лабораторией дизеринг-обоев",
  "changelog.4_0_0.added.dither_presets": "Пресеты дизеринга, палитры и подбор цветов с картинки",
  "changelog.4_0_0.added.wallpaper_fx":
    "Параллакс обоев, оверлей сканлайнов и CRT-пресет запекания",
  "changelog.4_0_0.added.spotlight": "Аниме дня, недели и месяца с отсчетом обновления",
  "changelog.4_0_0.added.random_menu": "Случайный тайтл из меню данных коллекции",
  "changelog.4_0_0.added.random_filters": "Случайное аниме по фильтрам AniList",
  "changelog.4_0_0.added.deeplinks": "Ссылки iluhaanime:// на аниме с кнопкой копирования",
  ...
  "changelog.4_0_0.added.franchise": "Список франшизы и раздел похожих в деталях аниме",
  "changelog.4_0_0.added.fav_people":
    "Избранное для тайтлов, авторов и персонажей из видов AniList",
  "changelog.4_0_0.added.bilingual_labels": "Названия кастомных статусов на двух языках",
  "changelog.4_0_0.added.descriptions": "Описания коллекции из AniList и TMDB",
  "changelog.4_0_0.added.filmstrip": "Просмотр кадров-стиллов лентой внутри приложения",
  "changelog.4_0_0.added.fonts": "Глобальный выбор шрифта: системные шрифты и загрузка файлов",
  ...
  "changelog.4_0_0.changed.anilist_tags": "Теги только для коллекции и сливаются с жанрами",
  "changelog.4_0_0.changed.jobcenter":
    "Центр задач удален; очередь и скан папок живут в своих панелях",
  "changelog.4_0_0.changed.semantic": "Офлайн семантический поиск удален",
  "changelog.4_0_0.changed.gif": "Анимированные GIF больше не ставятся обоями",
  ...
  "changelog.4_0_0.fixed.files": "Файлы показываются для каждого торрента, ошибки видны по каждому",
  ...
  "changelog.4_0_0.fixed.tmdb_covers": "Обложки TMDB грузятся через кэш бэкенда",
} as const;
