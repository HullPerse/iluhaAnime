const changelog403 = {
  "changelog.4_0_3.added.torrent_links":
    "Ссылки iluhaanime:// на торренты с предзаполненным диалогом добавления",
  "changelog.4_0_3.added.link_paste":
  ...
  "changelog.4_0_3.changed.root_sizes": "Размеры папок в плеере считают все дерево",
  "changelog.4_0_3.changed.sqlite_jump": "Переход к бэкапу включает вкладку SQLite",
  "changelog.4_0_3.fixed.anime_link_tab": "Ссылки на аниме открываются даже на вкладке AniList",
  "changelog.4_0_3.fixed.fav_errors": "Ошибки избранного и префетча уходят в трей уведомлений",
} as const;
