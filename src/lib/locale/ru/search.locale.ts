const search = {
  ...
  "search.operator.prefix": "названия с начала",
  "search.operator.suffix": "названия с конца",
  "search.operator.exact": "точное вхождение",
  "search.operator.exclude": "исключает названия",
  ...
  "search.dither.preset.ascii": "Глифы",
  ...
  "search.dither.palette.preset.violet": "Фиолетовая рампа",
  ...
  "search.dither.opt.ascii": "Глифы ASCII",
  "search.dither.opt.asciiSize": "Размер клетки ASCII",
  "search.dither.opt.asciiFringe": "Затухание ASCII к центру",
