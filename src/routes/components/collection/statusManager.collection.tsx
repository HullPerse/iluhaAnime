  ...
  return (
    ...
    >
      <div className="flex w-full flex-col gap-1">
        <p className="bg-secondary windows95-text text-title-text px-1 py-0.5 text-xs font-bold">
          {t("collection.status.manager.core.title")}
        </p>
        <ul className="windows95-border bg-field flex max-h-64 flex-col overflow-y-auto">
          {statuses
        ...
        <p className="bg-secondary windows95-text text-title-text flex items-center gap-1 px-1 py-0.5 text-xs font-bold">
